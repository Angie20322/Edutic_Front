const uneteVerificacion = (solicitud) => {
  const errores = {};
  ...
  if (!solicitud.materia.trim()) errores.direccion = "Espacio vacío";
  if (!solicitud.cargo.trim()) errores.direccion = "Espacio vacío";

  return errores;
};

export default uneteVerificacion;
