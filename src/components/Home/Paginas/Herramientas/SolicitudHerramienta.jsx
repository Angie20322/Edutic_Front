...
import verificarHerr from "./VerificarHerr.js";
import Sidebar from "../../Principal/Sidebar.jsx";

const SolicitudHerramienta = ({ open, setOpen, loginData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    Swal.fire({
      ...
      text: "¿Quieres agregar esta herramienta",
      icon: "warning",
...
export default SolicitudHerramienta;
