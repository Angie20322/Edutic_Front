...
import veriNoticias from "./veriNoticias.js";

const SolicitudNoticia = ({ open, setOpen, loginData }) => {
  ...
  const initialNoticia = {
    ...
    imagen: "",
    contenido: "",
    usuarioId: loginData.usuario.id,
  };
  ...
  const handleSubmit = async (e) => {
    ...
    Swal.fire({
      ...
      text: "¿Quieres agregar esta noticia?",
      icon: "warning",
        ...
        try {
          ...
          if (
            ...
            Swal.fire({
              ...
              text: "Solo falta que sea aprobada",
              icon: "success",
            });
      ...
      <div className="p-3 text-center lg:col-span-3 xl:col-span-5 bg-gray-100 w-screen h-screen overflow-y-scroll">
        <div>
          <div className="text-left p-6">
            ...
            <div className="mt-10">
              <div className="bg-white md:mx-80 py-4 md:px-4">
...
export default SolicitudNoticia;
